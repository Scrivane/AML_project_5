...
%%%%%%%%% ABSTRACT
\begin{abstract}
   Federated Learning has gained significant attention in recent years due to the widespread use of mobile devices.
  In a machine learning context, it requires shifting model training from a central server to end devices which help to minimize communication overhead and privacy risks. To address these challenges, we analyzed a centralized baseline, a federated one, the impact of client participation, and the effects of heterogeneous data distributions and further expanded in the
\end{abstract}
